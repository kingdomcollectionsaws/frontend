  ...
  const filters = [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'SUMSUNG', label: 'sumsung', checked: false },
        { value: 'OTHER(OP,REALME,VIVE,MI,ETC)', label: 'other', checked: false },
      ],
    },
    {
      id: 'size',
      name: 'Size',
      options: [
        { value: '10', label: '10inches', checked: false },
        { value: '11', label: '11inches', checked: false },
        { value: '12', label: '12inches', checked: false },
        { value: '13', label: '13inches', checked: false },
        { value: '14', label: '14inches', checked: false },
        { value: '15', label: '15inches', checked: false },
        { value: '16', label: '16inches', checked: false },
        { value: '17', label: '17inches', checked: false },
      ],
    },
    {
      id: 'price',
      ...
      options: [
        ...
        { value: '500-2000', label: '500-2000', checked: false },
        { value: '2000-5000', label: '2000-5000', checked: false },
        { value: '5000-10000', label: '5000-10000', checked: false },
        { value: '10000-20000', label: '10000-20000', checked: false },
        { value: '20000-40000', label: '20000-40000', checked: false },
        { value: '40000-80000', label: '40000-80000', checked: false },
        { value: '80000-200000', label: '80000-200000', checked: false },
      ],
    },
  ]
...
const param = useParams()
   ...
   useEffect(()=>{
    const [maxPrice,minPrice]= priceValue===null?[200000,0]:priceValue.split("-").map(Number);
    const Filterdata={
      brand:brandValue,
   ...
   console.log(products);
    },[param.category,colorValue,brandValue,sizeValue,sortValue,pageNumber])
...
{
   loading==true?"iiii":products?.map((i)=>( <Productcard product={i}/>))
}
                </div>
              </div>
            </div>
